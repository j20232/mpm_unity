...
public class UtilDraw2D {
	...
	private float m_lineWidthHalf = 0.0f; // Half of line width
	private float m_lineDot = 0.0f; // interval between points

	public UtilDraw2D (Material m) {
		m_lineMaterial = m;
	...
	// @param[in]  v0   start position
	// @param[in]  v1   end position
